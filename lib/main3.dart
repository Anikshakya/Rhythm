        ...
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            scaffoldBackgroundColor:
                ColorScheme.fromSeed(seedColor: color).surface,
            appBarTheme: AppBarTheme(
              backgroundColor: ColorScheme.fromSeed(seedColor: color).surface,
              foregroundColor: ColorScheme.fromSeed(seedColor: color).onSurface,
              elevation: 0,
            ),
            textTheme: TextTheme(
              bodyMedium: TextStyle(
                fontSize: 16,
                color: ColorScheme.fromSeed(seedColor: color).onSurface,
                fontFamily: 'SanFrancisco', // Cupertino-inspired font
              ),
              ...
              bodySmall: TextStyle(
                fontSize: 14,
                color: ColorScheme.fromSeed(seedColor: color).onSurfaceVariant,
                fontFamily: 'SanFrancisco',
              ),
            ),
...
class PlayerUI extends StatelessWidget {
  ...
  Widget _buildAnimatedCollapsedRow(BuildContext context, double percentage) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(context).colorScheme.surface.withOpacity(bgColor),
              ...
              builder: (context, playing, _) {
                return SizedBox(
                  ...
                  child: CupertinoButton.filled(
                    padding: EdgeInsets.zero,
                    borderRadius: BorderRadius.circular(iconSize * 1.65 / 2),
                    onPressed: () {
